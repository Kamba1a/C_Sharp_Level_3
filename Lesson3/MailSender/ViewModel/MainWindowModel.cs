...
namespace MailSender.ViewModel
{
    ...
    public class MainWindowModel : INotifyPropertyChanged
    {
        ...
        public static DataAccessService DAS;                                            //класс для работы с БД
        public static ObservableCollection<SmtpServers> SmtpServersCol { get; set; }    //коллекция Smtp-серверов
        public static ObservableCollection<SenderEmails> SenderEmailsCol { get; set; }  //коллекция емейлов отправителя
